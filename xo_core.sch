...
N -90 400 240 400 {lab=GND}
N 180 70 240 70 {lab=XO2}
N 240 70 240 140 {lab=XO2}
N -90 350 -90 400 {lab=GND}
...
N -160 400 -90 400 {lab=GND}
N 370 140 480 140 {lab=XO2}
...
footprint=1206
device="ceramic capacitor"}
C {iopin.sym} -160 400 2 0 {name=p1 lab=GND}
...
C {ipin.sym} 190 190 0 0 {name=p6 lab=XO2}
C {ipin.sym} -50 190 2 0 {name=p3 lab=XO1}
C {ipin.sym} 240 -160 1 0 {name=p4 lab=I_BIAS_IN}
C {opin.sym} 480 140 0 0 {name=p2 lab=V_OSC}
