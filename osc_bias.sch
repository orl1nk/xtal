...
N -80 470 160 470 {lab=GND}
N 150 210 150 260 {lab=#net1}
N 150 260 160 260 {lab=#net1}
N 160 240 160 260 {lab=#net1}
...
N 950 -140 950 -40 {lab=#net4}
N 1240 -140 1240 -40 {lab=#net5}
...
N 160 280 160 310 {lab=#net1}
N 200 280 200 340 {lab=#net1}
N 160 280 200 280 {lab=#net1}
N 160 260 160 280 {lab=#net1}
N 150 340 160 340 {lab=#net1}
N 150 260 150 340 {lab=#net1}
N 160 -130 160 -70 {lab=vp_bias}
N 160 370 160 390 {lab=#net6}
N 160 450 160 470 {lab=GND}
N 700 -150 700 -50 {lab=#net7}
...
C {sg13g2_pr/annotate_fet_params.sym} 457.5 5 0 0 {name=annot1 ref=M2}
...
C {sg13g2_pr/annotate_fet_params.sym} 460 170 0 0 {name=annot2 ref=M6}
