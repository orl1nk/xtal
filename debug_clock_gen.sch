...
N -230 -210 -40 -210 {lab=#net4}
N -230 -210 -230 -190 {lab=#net4}
N -320 -190 -230 -190 {lab=#net4}
N -0 -210 110 -210 {lab=#net1}
N 110 -400 110 -210 {lab=#net1}
N 0 230 -0 280 {lab=#net5}
N -0 90 0 170 {lab=#net6}
N -0 200 110 200 {lab=GND}
N 110 60 110 200 {lab=GND}
N -320 -170 -320 -50 {lab=#net7}
N -530 -50 -320 -50 {lab=#net7}
N -530 -50 -530 200 {lab=#net7}
N -530 200 -40 200 {lab=#net7}
...
C {sg13g2_pr/sg13_lv_pmos.sym} -20 -210 0 0 {name=M7
l=10u
w=1.8u
ng=1
m=1
