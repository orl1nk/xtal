...
N -30 290 -30 400 {lab=GND}
N -310 400 -30 400 {lab=GND}
N -30 110 -30 230 {lab=#net10}
N -100 110 -30 110 {lab=#net10}
...
.control 
*save all
save i(VDD) V_OSC V_OUT_BUFF trigger

*op
*write xo_toplevel_tran_tb.raw
...
C {vsource.sym} -850 140 0 0 {name=V_CFG_1 value=1.5}
...
C {lab_pin.sym} -130 -370 2 0 {name=p5 sig_type=std_logic lab=cfg_2}
C {lab_pin.sym} -130 -390 2 0 {name=p6 sig_type=std_logic lab=cfg_3}
...
C {vsource.sym} -680 -130 0 0 {name=V_CFG_7 value=0}
C {gnd.sym} -680 -100 0 0 {name=l8 lab=GND}
C {lab_pin.sym} -680 -160 0 0 {name=p25 sig_type=std_logic lab=enable_bias}
C {lab_pin.sym} -360 -410 0 0 {name=p26 sig_type=std_logic lab=enable_bias}
C {vsource.sym} -1240 140 0 0 {name=V_CFG_4 value="PULSE(1.5 0 1m)"
spice_ignore=true}
C {vsource.sym} -1240 240 0 0 {name=V_CFG_5 value="PULSE(1.5 0 1m)"
spice_ignore=true}
C {vsource.sym} -1050 150 0 0 {name=V_CFG_6 value="PULSE(1.5 0 1m)"
spice_ignore=true}
C {gnd.sym} -1240 170 0 0 {name=l5 lab=GND
spice_ignore=true}
C {gnd.sym} -1240 270 0 0 {name=l7 lab=GND
spice_ignore=true}
C {gnd.sym} -1050 180 0 0 {name=l9 lab=GND
spice_ignore=true}
C {lab_pin.sym} -1240 110 0 0 {name=p27 sig_type=std_logic lab=cfg_1
spice_ignore=true}
C {lab_pin.sym} -1240 210 0 0 {name=p28 sig_type=std_logic lab=cfg_2
spice_ignore=true}
C {lab_pin.sym} -1050 120 0 0 {name=p29 sig_type=std_logic lab=cfg_3
spice_ignore=true}
C {isource.sym} -30 260 2 0 {name=I0 value="PULSE(1n 0 10u)"}
