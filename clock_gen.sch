...
N 270 350 390 350 {lab=VSS}
N 110 350 270 350 {lab=VSS}
...
N 390 350 540 350 {lab=VSS}
N 230 200 500 200 {lab=VN_BIAS}
N 500 130 500 200 {lab=VN_BIAS}
N 0 170 0 210 {lab=#net8}
N 0 270 0 350 {lab=VSS}
N 110 140 110 350 {lab=VSS}
N 270 170 270 350 {lab=VSS}
N 390 140 390 350 {lab=VSS}
N 540 160 540 350 {lab=VSS}
N 610 130 610 350 {lab=VSS}
N -0 -310 0 -260 {lab=#net9}
N 110 -430 110 -320 {lab=VDD}
...
C {iopin.sym} 0 400 0 0 {name=p1 lab=VSS}
C {iopin.sym} 0 -470 0 0 {name=p2 lab=VDD}
C {ipin.sym} -345 -30 0 0 {name=p3 lab=IN}
...
C {ammeter.sym} 0 240 0 0 {name=Vmeas_NMOS savecurrent=true spice_ignore=0}
C {ammeter.sym} 0 -340 0 0 {name=Vmeas_PMOS savecurrent=true spice_ignore=0}
