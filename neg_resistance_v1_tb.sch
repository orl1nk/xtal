...
N -90 -220 -70 -220 {lab=#net2}
N -170 -220 -160 -220 {lab=A}
N -170 -180 -130 -180 {lab=A}
N -170 -220 -170 -180 {lab=A}
N -190 -220 -170 -220 {lab=A}
N -90 -180 -40 -180 {lab=#net2}
N -90 -220 -90 -180 {lab=#net2}
N -100 -220 -90 -220 {lab=#net2}
N -10 -220 30 -220 {lab=B}
N 30 -310 30 -220 {lab=B}
...
N -40 -230 -40 -220 {lab=#net2}
N -70 -230 -70 -220 {lab=#net2}
N -70 -230 -40 -230 {lab=#net2}
...
C {isource.sym} 30 -340 0 0 {name=I0 value=20n}
...
op
write neg_resistance_v1_tb.raw
set appendwrite
...
C {devices/launcher.sym} 380 -190 0 0 {name=h3
descr="simulate" 
